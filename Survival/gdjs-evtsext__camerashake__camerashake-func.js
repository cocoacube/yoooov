...
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(0).setNumber(1 / (typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("ShakePeriod")) || 0 : 0));
}}
...
}{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(7).setString((typeof eventsFunctionContext !== 'undefined' ? "" + eventsFunctionContext.getArgument("Layer") : ""));
}{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(5).setNumber((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("Duration")) || 0 : 0));
}{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(10).setNumber(0);
}{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(11).setNumber((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("Duration")) || 0 : 0));
}{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(1).setNumber(Math.abs((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("AmplitudeX")) || 0 : 0)));
}{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(2).setNumber(Math.abs((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("AmplitudeY")) || 0 : 0)));
}{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(3).setNumber((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("AmplitudeAngle")) || 0 : 0));
}{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(4).setNumber(1 + (typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("AmplitudeZoom")) || 0 : 0) / 100);
}
{ //Subevents

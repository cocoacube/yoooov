...
gdjs.GameCode.GDBasketBall1Objects1= [];
gdjs.GameCode.GDBasketBall1Objects2= [];
gdjs.GameCode.GDBasketBall1Objects3= [];
gdjs.GameCode.GDBasketBall1Objects4= [];
gdjs.GameCode.GDvObjects1= [];
gdjs.GameCode.GDvObjects2= [];
gdjs.GameCode.GDvObjects3= [];
gdjs.GameCode.GDvObjects4= [];


gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBasketBall1Objects2Objects = Hashtable.newFrom({"BasketBall1": gdjs.GameCode.GDBasketBall1Objects2});
gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDvObjects2Objects = Hashtable.newFrom({"v": gdjs.GameCode.GDvObjects2});
...
gdjs.copyArray(gdjs.GameCode.GDvObjects2, gdjs.GameCode.GDvObjects3);


let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDvObjects3.length;i<l;++i) {
    if ( gdjs.GameCode.GDvObjects3[i].getBehavior("Opacity").getOpacity() < 180 ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDvObjects3[k] = gdjs.GameCode.GDvObjects3[i];
        ++k;
    }
}
gdjs.GameCode.GDvObjects3.length = k;
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Peg_Basic"), gdjs.GameCode.GDPeg_9595BasicObjects3);
gdjs.copyArray(runtimeScene.getObjects("Peg_Move"), gdjs.GameCode.GDPeg_9595MoveObjects3);
/* Reuse gdjs.GameCode.GDvObjects3 */
gdjs.GameCode.GDPegDeath_9595ParticleObjects3.length = 0;

{for(var i = 0, len = gdjs.GameCode.GDvObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDvObjects3[i].deleteFromScene(runtimeScene);
}
...
};gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBasketBall1Objects1Objects = Hashtable.newFrom({"BasketBall1": gdjs.GameCode.GDBasketBall1Objects1});
...
gdjs.copyArray(gdjs.GameCode.GDBasketBall1Objects1, gdjs.GameCode.GDBasketBall1Objects2);


let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDBasketBall1Objects2.length;i<l;++i) {
    if ( gdjs.GameCode.GDBasketBall1Objects2[i].getVariableNumber(gdjs.GameCode.GDBasketBall1Objects2[i].getVariables().getFromIndex(1)) > 0 ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDBasketBall1Objects2[k] = gdjs.GameCode.GDBasketBall1Objects2[i];
        ++k;
    }
}
gdjs.GameCode.GDBasketBall1Objects2.length = k;
if (isConditionTrue_0) {
...
/* Reuse gdjs.GameCode.GDBasketBall1Objects1 */

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDBasketBall1Objects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDBasketBall1Objects1[i].getVariableNumber(gdjs.GameCode.GDBasketBall1Objects1[i].getVariables().getFromIndex(1)) < 1 ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDBasketBall1Objects1[k] = gdjs.GameCode.GDBasketBall1Objects1[i];
        ++k;
    }
}
gdjs.GameCode.GDBasketBall1Objects1.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDBasketBall1Objects1 */
{for(var i = 0, len = gdjs.GameCode.GDBasketBall1Objects1.length ;i < len;++i) {
    gdjs.GameCode.GDBasketBall1Objects1[i].deleteFromScene(runtimeScene);
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11535972);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDBasketBall1Objects1 */
...
{for(var i = 0, len = gdjs.GameCode.GDBasketBall1Objects1.length ;i < len;++i) {
    gdjs.GameCode.GDBasketBall1Objects1[i].returnVariable(gdjs.GameCode.GDBasketBall1Objects1[i].getVariables().getFromIndex(2)).setBoolean(true);
}
}{for(var i = 0, len = gdjs.GameCode.GDBasketBall1Objects1.length ;i < len;++i) {
    gdjs.GameCode.GDBasketBall1Objects1[i].activateBehavior("Physics2", true);
}
}{gdjs.evtTools.sound.playSound(runtimeScene, "ClickerBeep.wav", false, 50, 0.8);
}{for(var i = 0, len = gdjs.GameCode.GDBasketBall1Objects1.length ;i < len;++i) {
    gdjs.GameCode.GDBasketBall1Objects1[i].returnVariable(gdjs.GameCode.GDBasketBall1Objects1[i].getVariables().getFromIndex(1)).sub(1);
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11542308);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11542236);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("NewTextInput"), gdjs.GameCode.GDNewTextInputObjects2);
{gdjs.evtTools.leaderboards.savePlayerScore(runtimeScene, "2a0fb72c-383e-40e8-86b9-09e95e13de51", runtimeScene.getGame().getVariables().getFromIndex(0).getAsNumber(), (( gdjs.GameCode.GDNewTextInputObjects2.length === 0 ) ? "" :gdjs.GameCode.GDNewTextInputObjects2[0].getText()));
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11546380);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11546292);
}
}
if (isConditionTrue_0) {
{runtimeScene.getGame().getVariables().getFromIndex(1).setNumber(0);
...
gdjs.copyArray(runtimeScene.getObjects("BasketBall1"), gdjs.GameCode.GDBasketBall1Objects1);
...
{for(var i = 0, len = gdjs.GameCode.GDMultiplierObjects1.length ;i < len;++i) {
    ...
    gdjs.GameCode.GDBasketBall1Objects1[i].activateBehavior("Physics2", false);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("v"), gdjs.GameCode.GDvObjects1);

for (gdjs.GameCode.forEachIndex2 = 0;gdjs.GameCode.forEachIndex2 < gdjs.GameCode.GDvObjects1.length;++gdjs.GameCode.forEachIndex2) {
gdjs.copyArray(runtimeScene.getObjects("BasketBall1"), gdjs.GameCode.GDBasketBall1Objects2);
gdjs.GameCode.GDvObjects2.length = 0;


gdjs.GameCode.forEachTemporary2 = gdjs.GameCode.GDvObjects1[gdjs.GameCode.forEachIndex2];
gdjs.GameCode.GDvObjects2.push(gdjs.GameCode.forEachTemporary2);
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.physics2.haveObjectsStartedColliding(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBasketBall1Objects2Objects, "Physics2", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDvObjects2Objects, false);
if (isConditionTrue_0) {
{runtimeScene.getGame().getVariables().getFromIndex(0).add(runtimeScene.getScene().getVariables().getFromIndex(0).getAsNumber());
}{gdjs.evtTools.sound.playSound(runtimeScene, "ClickerBeep.wav", false, 20, 0);
}{for(var i = 0, len = gdjs.GameCode.GDvObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDvObjects2[i].getBehavior("ShakeObject_PositionAngleScale").ShakeObject_PositionAngleScale(0.2, 0, 0, 0, -(30), 0.1, false, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{for(var i = 0, len = gdjs.GameCode.GDvObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDvObjects2[i].getBehavior("Opacity").setOpacity(gdjs.GameCode.GDvObjects2[i].getBehavior("Opacity").getOpacity() - (30));
}
}{for(var i = 0, len = gdjs.GameCode.GDBasketBall1Objects2.length ;i < len;++i) {
    gdjs.GameCode.GDBasketBall1Objects2[i].returnVariable(gdjs.GameCode.GDBasketBall1Objects2[i].getVariables().getFromIndex(0)).add(0.05);
}
}{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "Ball_Pitch");
}{for(var i = 0, len = gdjs.GameCode.GDvObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDvObjects2[i].setColor("114;114;114");
}
}
{ //Subevents: 
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.physics2.haveObjectsStartedColliding(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBasketBall1Objects1Objects, "Physics2", gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDPeg_95959595BiggerObjects1Objects, false);
if (isConditionTrue_0) {
/* Reuse gdjs.GameCode.GDBasketBall1Objects1 */
...
{runtimeScene.getGame().getVariables().getFromIndex(0).add(runtimeScene.getScene().getVariables().getFromIndex(0).getAsNumber() * 2);
    ...
    gdjs.GameCode.GDBasketBall1Objects1[i].returnVariable(gdjs.GameCode.GDBasketBall1Objects1[i].getVariables().getFromIndex(0)).add(0.05);
}
}{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "Ball_Pitch");
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDBasketBall1Objects1Objects, gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDMultiplierObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11525444);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11530780);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("BasketBall1"), gdjs.GameCode.GDBasketBall1Objects1);
{for(var i = 0, len = gdjs.GameCode.GDBasketBall1Objects1.length ;i < len;++i) {
    gdjs.GameCode.GDBasketBall1Objects1[i].returnVariable(gdjs.GameCode.GDBasketBall1Objects1[i].getVariables().getFromIndex(0)).setNumber(1);
}
}}
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDBasketBall1Objects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDBasketBall1Objects1[i].getY() > 1000 ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDBasketBall1Objects1[k] = gdjs.GameCode.GDBasketBall1Objects1[i];
        ++k;
    }
...
{for(var i = 0, len = gdjs.GameCode.GDBasketBall1Objects1.length ;i < len;++i) {
    ...
    gdjs.GameCode.GDBasketBall1Objects1[i].setY(120);
}
}{for(var i = 0, len = gdjs.GameCode.GDBasketBall1Objects1.length ;i < len;++i) {
    gdjs.GameCode.GDBasketBall1Objects1[i].returnVariable(gdjs.GameCode.GDBasketBall1Objects1[i].getVariables().getFromIndex(2)).setBoolean(false);
}
}{for(var i = 0, len = gdjs.GameCode.GDBasketBall1Objects1.length ;i < len;++i) {
    gdjs.GameCode.GDBasketBall1Objects1[i].getBehavior("ShakeObject_PositionAngleScale").ShakeObject_PositionAngleScale(0.4, 0, 0, 0, 60, 0.4, false, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}
{ //Subevents
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.GameCode.GDBasketBall1Objects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDBasketBall1Objects1[i].getVariableBoolean(gdjs.GameCode.GDBasketBall1Objects1[i].getVariables().getFromIndex(2), false, false) ) {
        isConditionTrue_0 = true;
        gdjs.GameCode.GDBasketBall1Objects1[k] = gdjs.GameCode.GDBasketBall1Objects1[i];
        ++k;
    }
...
/* Reuse gdjs.GameCode.GDBasketBall1Objects1 */
{for(var i = 0, len = gdjs.GameCode.GDBasketBall1Objects1.length ;i < len;++i) {
    gdjs.GameCode.GDBasketBall1Objects1[i].setX(gdjs.evtTools.common.clamp(48, gdjs.evtTools.input.getCursorX(runtimeScene, "", 0), 752));
}
}
{ //Subevents
...
{runtimeScene.getGame().getVariables().getFromIndex(1).setNumber(Math.floor(runtimeScene.getGame().getVariables().getFromIndex(0).getAsNumber()));
    ...
    gdjs.GameCode.GDLivesObjects1[i].getBehavior("Text").setText("Lives: " + ((gdjs.GameCode.GDBasketBall1Objects1.length === 0 ) ? gdjs.VariablesContainer.badVariablesContainer : gdjs.GameCode.GDBasketBall1Objects1[0].getVariables()).getFromIndex(1).getAsString());
}
}}
...
gdjs.GameCode.GDBasketBall1Objects1.length = 0;
gdjs.GameCode.GDBasketBall1Objects2.length = 0;
gdjs.GameCode.GDBasketBall1Objects3.length = 0;
gdjs.GameCode.GDBasketBall1Objects4.length = 0;
gdjs.GameCode.GDvObjects1.length = 0;
gdjs.GameCode.GDvObjects2.length = 0;
gdjs.GameCode.GDvObjects3.length = 0;
gdjs.GameCode.GDvObjects4.length = 0;

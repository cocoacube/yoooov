...
gdjs.PlaySceneCode.GDNewSpriteObjects5= [];
gdjs.PlaySceneCode.GDNewSpriteObjects6= [];
gdjs.PlaySceneCode.GDBF109Objects1= [];
gdjs.PlaySceneCode.GDBF109Objects2= [];
gdjs.PlaySceneCode.GDBF109Objects3= [];
gdjs.PlaySceneCode.GDBF109Objects4= [];
gdjs.PlaySceneCode.GDBF109Objects5= [];
gdjs.PlaySceneCode.GDBF109Objects6= [];
gdjs.PlaySceneCode.GDHolyExplosionObjects1= [];
gdjs.PlaySceneCode.GDHolyExplosionObjects2= [];
gdjs.PlaySceneCode.GDHolyExplosionObjects3= [];
gdjs.PlaySceneCode.GDHolyExplosionObjects4= [];
gdjs.PlaySceneCode.GDHolyExplosionObjects5= [];
gdjs.PlaySceneCode.GDHolyExplosionObjects6= [];
gdjs.PlaySceneCode.GDRedFlatBarObjects1= [];
gdjs.PlaySceneCode.GDRedFlatBarObjects2= [];
gdjs.PlaySceneCode.GDRedFlatBarObjects3= [];
gdjs.PlaySceneCode.GDRedFlatBarObjects4= [];
gdjs.PlaySceneCode.GDRedFlatBarObjects5= [];
gdjs.PlaySceneCode.GDRedFlatBarObjects6= [];
gdjs.PlaySceneCode.GDBullet2Objects1= [];
gdjs.PlaySceneCode.GDBullet2Objects2= [];
gdjs.PlaySceneCode.GDBullet2Objects3= [];
gdjs.PlaySceneCode.GDBullet2Objects4= [];
gdjs.PlaySceneCode.GDBullet2Objects5= [];
gdjs.PlaySceneCode.GDBullet2Objects6= [];
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("BF109"), gdjs.PlaySceneCode.GDBF109Objects1);
{runtimeScene.getScene().getVariables().getFromIndex(0).setString("GamePlaying");
}{gdjs.evtTools.sound.playSound(runtimeScene, "fd264cb39ba37f705f0c60f694f2e54f4b2295231c2256513691a7309438f882_Beginning of Conflict.aac", true, 100, 1);
}{for(var i = 0, len = gdjs.PlaySceneCode.GDBF109Objects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDBF109Objects1[i].resetTimer("B");
}
}
{ //Subevents
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17908364);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("MotionTrail"), gdjs.PlaySceneCode.GDMotionTrailObjects3);
...
{for(var i = 0, len = gdjs.PlaySceneCode.GDPlayerObjects2.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDPlayerObjects2[i].getBehavior("FireBullet").Fire((gdjs.PlaySceneCode.GDPlayerObjects2[i].getPointX("BulletSpawn")), (gdjs.PlaySceneCode.GDPlayerObjects2[i].getPointY("BulletSpawn")), gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDBulletObjects2Objects, (gdjs.PlaySceneCode.GDPlayerObjects2[i].getAngle()), 250, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
...
gdjs.PlaySceneCode.asyncCallback17939836 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.PlaySceneCode.asyncCallback17939836(runtimeScene, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17937244);
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.PlaySceneCode.GDPlayerObjects3);
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17938796);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17938668);
}
if (isConditionTrue_0) {
...
gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDBF109Objects1Objects = Hashtable.newFrom({"BF109": gdjs.PlaySceneCode.GDBF109Objects1});
gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDHolyExplosionObjects1Objects = Hashtable.newFrom({"HolyExplosion": gdjs.PlaySceneCode.GDHolyExplosionObjects1});
gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDRedFlatBarObjects1Objects = Hashtable.newFrom({"RedFlatBar": gdjs.PlaySceneCode.GDRedFlatBarObjects1});
gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDHolyExplosionObjects1Objects = Hashtable.newFrom({"HolyExplosion": gdjs.PlaySceneCode.GDHolyExplosionObjects1});
gdjs.PlaySceneCode.eventsList17 = function(runtimeScene) {

{

/* Reuse gdjs.PlaySceneCode.GDBF109Objects1 */

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.PlaySceneCode.GDBF109Objects1.length;i<l;++i) {
    if ( gdjs.PlaySceneCode.GDBF109Objects1[i].getBehavior("Health").IsDead((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.PlaySceneCode.GDBF109Objects1[k] = gdjs.PlaySceneCode.GDBF109Objects1[i];
        ++k;
    }
}
gdjs.PlaySceneCode.GDBF109Objects1.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.PlaySceneCode.GDBF109Objects1 */
gdjs.copyArray(runtimeScene.getObjects("Bullet2"), gdjs.PlaySceneCode.GDBullet2Objects1);
/* Reuse gdjs.PlaySceneCode.GDHolyExplosionObjects1 */
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDHolyExplosionObjects1Objects, (( gdjs.PlaySceneCode.GDBF109Objects1.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDBF109Objects1[0].getCenterXInScene()), (( gdjs.PlaySceneCode.GDBF109Objects1.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDBF109Objects1[0].getCenterYInScene()), "");
}{for(var i = 0, len = gdjs.PlaySceneCode.GDBF109Objects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDBF109Objects1[i].deleteFromScene(runtimeScene);
}
}{for(var i = 0, len = gdjs.PlaySceneCode.GDBullet2Objects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDBullet2Objects1[i].deleteFromScene(runtimeScene);
}
}}
...
};gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDBullet2Objects2Objects = Hashtable.newFrom({"Bullet2": gdjs.PlaySceneCode.GDBullet2Objects2});
...
for (gdjs.PlaySceneCode.forEachIndex2 = 0;gdjs.PlaySceneCode.forEachIndex2 < gdjs.PlaySceneCode.GDBF109Objects1.length;++gdjs.PlaySceneCode.forEachIndex2) {
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.PlaySceneCode.GDPlayerObjects2);
gdjs.PlaySceneCode.GDBullet2Objects2.length = 0;

gdjs.PlaySceneCode.GDBF109Objects2.length = 0;


gdjs.PlaySceneCode.forEachTemporary2 = gdjs.PlaySceneCode.GDBF109Objects1[gdjs.PlaySceneCode.forEachIndex2];
gdjs.PlaySceneCode.GDBF109Objects2.push(gdjs.PlaySceneCode.forEachTemporary2);
let isConditionTrue_0 = false;
if (true) {
{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDBullet2Objects2Objects, (( gdjs.PlaySceneCode.GDBF109Objects2.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDBF109Objects2[0].getCenterXInScene()), (( gdjs.PlaySceneCode.GDBF109Objects2.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDBF109Objects2[0].getCenterYInScene()), "");
}{for(var i = 0, len = gdjs.PlaySceneCode.GDBullet2Objects2.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDBullet2Objects2[i].addForceTowardObject((gdjs.PlaySceneCode.GDPlayerObjects2.length !== 0 ? gdjs.PlaySceneCode.GDPlayerObjects2[0] : null), 250, 1);
}
}{for(var i = 0, len = gdjs.PlaySceneCode.GDBF109Objects2.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDBF109Objects2[i].resetTimer("B");
}
}}
}
...
};gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDBullet2Objects1Objects = Hashtable.newFrom({"Bullet2": gdjs.PlaySceneCode.GDBullet2Objects1});
gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDPlayerObjects1Objects = Hashtable.newFrom({"Player": gdjs.PlaySceneCode.GDPlayerObjects1});
gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDHolyExplosionObjects1Objects = Hashtable.newFrom({"HolyExplosion": gdjs.PlaySceneCode.GDHolyExplosionObjects1});
gdjs.PlaySceneCode.eventsList20 = function(runtimeScene) {

{

/* Reuse gdjs.PlaySceneCode.GDLifeBarObjects1 */

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.PlaySceneCode.GDLifeBarObjects1.length;i<l;++i) {
    if ( gdjs.PlaySceneCode.GDLifeBarObjects1[i].IsEmpty((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.PlaySceneCode.GDLifeBarObjects1[k] = gdjs.PlaySceneCode.GDLifeBarObjects1[i];
        ++k;
    }
}
gdjs.PlaySceneCode.GDLifeBarObjects1.length = k;
if (isConditionTrue_0) {
...
};gdjs.PlaySceneCode.mapOfEmptyGDBF109Objects = Hashtable.newFrom({"BF109": []});
...
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.PlaySceneCode.GDPlayerObjects1);
{for(var i = 0, len = gdjs.PlaySceneCode.GDBF109Objects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDBF109Objects1[i].rotateTowardPosition((( gdjs.PlaySceneCode.GDPlayerObjects1.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDPlayerObjects1[0].getCenterXInScene()), (( gdjs.PlaySceneCode.GDPlayerObjects1.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDPlayerObjects1[0].getCenterYInScene()), 100, runtimeScene);
}
}{for(var i = 0, len = gdjs.PlaySceneCode.GDBF109Objects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDBF109Objects1[i].addForceTowardObject((gdjs.PlaySceneCode.GDPlayerObjects1.length !== 0 ? gdjs.PlaySceneCode.GDPlayerObjects1[0] : null), 10, 0);
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDBulletObjects1Objects, gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDBF109Objects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
/* Reuse gdjs.PlaySceneCode.GDBF109Objects1 */
/* Reuse gdjs.PlaySceneCode.GDBulletObjects1 */
gdjs.PlaySceneCode.GDHolyExplosionObjects1.length = 0;

gdjs.PlaySceneCode.GDRedFlatBarObjects1.length = 0;

{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDHolyExplosionObjects1Objects, (( gdjs.PlaySceneCode.GDBF109Objects1.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDBF109Objects1[0].getCenterXInScene()), (( gdjs.PlaySceneCode.GDBF109Objects1.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDBF109Objects1[0].getCenterYInScene()), "");
}{gdjs.evtTools.sound.playSound(runtimeScene, "Explosion.wav", false, 100, 1);
}{for(var i = 0, len = gdjs.PlaySceneCode.GDBulletObjects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDBulletObjects1[i].deleteFromScene(runtimeScene);
}
}{for(var i = 0, len = gdjs.PlaySceneCode.GDHolyExplosionObjects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDHolyExplosionObjects1[i].deleteFromScene(runtimeScene);
}
}{for(var i = 0, len = gdjs.PlaySceneCode.GDBF109Objects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDBF109Objects1[i].getBehavior("Health").Hit(1, true, true, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDRedFlatBarObjects1Objects, (( gdjs.PlaySceneCode.GDBF109Objects1.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDBF109Objects1[0].getCenterXInScene()), (( gdjs.PlaySceneCode.GDBF109Objects1.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDBF109Objects1[0].getCenterYInScene()), "");
}{for(var i = 0, len = gdjs.PlaySceneCode.GDRedFlatBarObjects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDRedFlatBarObjects1[i].resetTimer("t");
}
}{for(var i = 0, len = gdjs.PlaySceneCode.GDRedFlatBarObjects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDRedFlatBarObjects1[i].SetValue((( gdjs.PlaySceneCode.GDBF109Objects1.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDBF109Objects1[0].getBehavior("Health").Health((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined))), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{for(var i = 0, len = gdjs.PlaySceneCode.GDRedFlatBarObjects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDRedFlatBarObjects1[i].getBehavior("Scale").setScale(0.3);
}
}
{ //Subevents
...
gdjs.copyArray(runtimeScene.getObjects("RedFlatBar"), gdjs.PlaySceneCode.GDRedFlatBarObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.PlaySceneCode.GDRedFlatBarObjects1.length;i<l;++i) {
    if ( gdjs.PlaySceneCode.GDRedFlatBarObjects1[i].getTimerElapsedTimeInSecondsOrNaN("t") >= 1 ) {
        isConditionTrue_0 = true;
        gdjs.PlaySceneCode.GDRedFlatBarObjects1[k] = gdjs.PlaySceneCode.GDRedFlatBarObjects1[i];
        ++k;
    }
}
gdjs.PlaySceneCode.GDRedFlatBarObjects1.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.PlaySceneCode.GDRedFlatBarObjects1 */
{for(var i = 0, len = gdjs.PlaySceneCode.GDRedFlatBarObjects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDRedFlatBarObjects1[i].deleteFromScene(runtimeScene);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("HolyExplosion"), gdjs.PlaySceneCode.GDHolyExplosionObjects1);

let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.PlaySceneCode.GDHolyExplosionObjects1.length;i<l;++i) {
    if ( gdjs.PlaySceneCode.GDHolyExplosionObjects1[i].getBehavior("Animation").hasAnimationEnded() ) {
        isConditionTrue_0 = true;
        gdjs.PlaySceneCode.GDHolyExplosionObjects1[k] = gdjs.PlaySceneCode.GDHolyExplosionObjects1[i];
        ++k;
    }
}
gdjs.PlaySceneCode.GDHolyExplosionObjects1.length = k;
if (isConditionTrue_0) {
/* Reuse gdjs.PlaySceneCode.GDHolyExplosionObjects1 */
{for(var i = 0, len = gdjs.PlaySceneCode.GDHolyExplosionObjects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDHolyExplosionObjects1[i].deleteFromScene(runtimeScene);
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.PlaySceneCode.GDBF109Objects1.length;i<l;++i) {
    if ( gdjs.PlaySceneCode.GDBF109Objects1[i].getTimerElapsedTimeInSecondsOrNaN("B") >= 4 ) {
        isConditionTrue_0 = true;
        gdjs.PlaySceneCode.GDBF109Objects1[k] = gdjs.PlaySceneCode.GDBF109Objects1[i];
        ++k;
    }
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDBullet2Objects1Objects, gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDPlayerObjects1Objects, false, runtimeScene, false);
if (isConditionTrue_0) {
/* Reuse gdjs.PlaySceneCode.GDBullet2Objects1 */
gdjs.copyArray(runtimeScene.getObjects("LifeBar"), gdjs.PlaySceneCode.GDLifeBarObjects1);
/* Reuse gdjs.PlaySceneCode.GDPlayerObjects1 */
gdjs.PlaySceneCode.GDHolyExplosionObjects1.length = 0;

{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.PlaySceneCode.mapOfGDgdjs_9546PlaySceneCode_9546GDHolyExplosionObjects1Objects, (( gdjs.PlaySceneCode.GDPlayerObjects1.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDPlayerObjects1[0].getCenterXInScene()), (( gdjs.PlaySceneCode.GDPlayerObjects1.length === 0 ) ? 0 :gdjs.PlaySceneCode.GDPlayerObjects1[0].getCenterYInScene()), "");
}{gdjs.evtTools.sound.playSound(runtimeScene, "Explosion.wav", false, 100, 1);
}{for(var i = 0, len = gdjs.PlaySceneCode.GDBullet2Objects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDBullet2Objects1[i].deleteFromScene(runtimeScene);
}
...
}{for(var i = 0, len = gdjs.PlaySceneCode.GDLifeBarObjects1.length ;i < len;++i) {
    gdjs.PlaySceneCode.GDLifeBarObjects1[i].SetValue(gdjs.PlaySceneCode.GDLifeBarObjects1[i].Value((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) - (1), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}
{ //Subevents
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.object.getSceneInstancesCount((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.PlaySceneCode.mapOfEmptyGDBF109Objects) == 0;
if (isConditionTrue_0) {
...
gdjs.PlaySceneCode.GDNewSpriteObjects5.length = 0;
gdjs.PlaySceneCode.GDNewSpriteObjects6.length = 0;
gdjs.PlaySceneCode.GDBF109Objects1.length = 0;
gdjs.PlaySceneCode.GDBF109Objects2.length = 0;
gdjs.PlaySceneCode.GDBF109Objects3.length = 0;
gdjs.PlaySceneCode.GDBF109Objects4.length = 0;
gdjs.PlaySceneCode.GDBF109Objects5.length = 0;
gdjs.PlaySceneCode.GDBF109Objects6.length = 0;
gdjs.PlaySceneCode.GDHolyExplosionObjects1.length = 0;
gdjs.PlaySceneCode.GDHolyExplosionObjects2.length = 0;
gdjs.PlaySceneCode.GDHolyExplosionObjects3.length = 0;
gdjs.PlaySceneCode.GDHolyExplosionObjects4.length = 0;
gdjs.PlaySceneCode.GDHolyExplosionObjects5.length = 0;
gdjs.PlaySceneCode.GDHolyExplosionObjects6.length = 0;
gdjs.PlaySceneCode.GDRedFlatBarObjects1.length = 0;
gdjs.PlaySceneCode.GDRedFlatBarObjects2.length = 0;
gdjs.PlaySceneCode.GDRedFlatBarObjects3.length = 0;
gdjs.PlaySceneCode.GDRedFlatBarObjects4.length = 0;
gdjs.PlaySceneCode.GDRedFlatBarObjects5.length = 0;
gdjs.PlaySceneCode.GDRedFlatBarObjects6.length = 0;
gdjs.PlaySceneCode.GDBullet2Objects1.length = 0;
gdjs.PlaySceneCode.GDBullet2Objects2.length = 0;
gdjs.PlaySceneCode.GDBullet2Objects3.length = 0;
gdjs.PlaySceneCode.GDBullet2Objects4.length = 0;
gdjs.PlaySceneCode.GDBullet2Objects5.length = 0;
gdjs.PlaySceneCode.GDBullet2Objects6.length = 0;

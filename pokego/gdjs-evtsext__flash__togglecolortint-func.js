...
{for(var i = 0, len = gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects2.length ;i < len;++i) {
    gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects2[i].returnVariable(gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects2[i].getVariables().get("__Flash_ColorTintToggled")).setBoolean(false);
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects2.length ;i < len;++i) {
    ...
    gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects2[i].returnVariable(gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects2[i].getVariables().get("__Flash_ColorTintToggled")).setBoolean(true);
}
}}
...
for (var i = 0, k = 0, l = gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1[i].getVariableBoolean(gdjs.evtsExt__Flash__ToggleColorTint.GDObjectObjects1[i].getVariables().get("__Flash_ColorTintToggled"), false, false) ) {

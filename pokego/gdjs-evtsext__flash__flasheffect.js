...
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects2.length ;i < len;++i) {
    gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects2[i].returnVariable(gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects2[i].getVariables().get("__FlashColor_StartingState")).setBoolean(true);
}
}}
...
/* Reuse gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects2 */
{for(var i = 0, len = gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects2.length ;i < len;++i) {
    gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects2[i].returnVariable(gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.FlashContext.GDObjectObjects2[i].getVariables().get("__FlashColor_StartingState")).setBoolean(false);
}
}}
...
for (var i = 0, k = 0, l = gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.StopContext.GDObjectObjects2.length;i<l;++i) {
    if ( gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.StopContext.GDObjectObjects2[i].getVariableBoolean(gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.StopContext.GDObjectObjects2[i].getVariables().get("__FlashEffect_StartingState"), true, false) ) {
        isConditionTrue_0 = true;
...
for (var i = 0, k = 0, l = gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.StopContext.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.StopContext.GDObjectObjects1[i].getVariableBoolean(gdjs.evtsExt__Flash__FlashEffect.FlashEffect.prototype.StopContext.GDObjectObjects1[i].getVariables().get("__FlashEffect_StartingState"), false, false) ) {
        isConditionTrue_0 = true;

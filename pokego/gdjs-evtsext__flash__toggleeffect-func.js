...
{for(var i = 0, len = gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[i].returnVariable(gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[i].getVariables().get("__Flash_EffectToggled")).setBoolean(false);
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1.length ;i < len;++i) {
    ...
    gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[i].returnVariable(gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[i].getVariables().get("__Flash_EffectToggled")).setBoolean(true);
}
}}
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[i].getVariableBoolean(gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[i].getVariables().get("__Flash_EffectToggled"), false, false) ) {
        isConditionTrue_0 = true;
        gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[k] = gdjs.evtsExt__Flash__ToggleEffect.GDObjectObjects1[i];
        ++k;
    }

...
let isConditionTrue_0 = false;
{
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getIdleEffect(); }}}
...
{for(var i = 0, len = gdjs.evtsExt__ButtonStates__ButtonObjectEffects.ButtonObjectEffects.prototype.SetIdleEffectContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ButtonStates__ButtonObjectEffects.ButtonObjectEffects.prototype.SetIdleEffectContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setIdleEffect(eventsFunctionContext.getArgument("Value"));
}
}}
...
let isConditionTrue_0 = false;
{
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getFocusedEffect(); }}}
...
{for(var i = 0, len = gdjs.evtsExt__ButtonStates__ButtonObjectEffects.ButtonObjectEffects.prototype.SetFocusedEffectContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ButtonStates__ButtonObjectEffects.ButtonObjectEffects.prototype.SetFocusedEffectContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setFocusedEffect(eventsFunctionContext.getArgument("Value"));
}
}}
...
let isConditionTrue_0 = false;
{
{if (typeof eventsFunctionContext !== 'undefined') { eventsFunctionContext.returnValue = eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getPressedEffect(); }}}
...
{for(var i = 0, len = gdjs.evtsExt__ButtonStates__ButtonObjectEffects.ButtonObjectEffects.prototype.SetPressedEffectContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ButtonStates__ButtonObjectEffects.ButtonObjectEffects.prototype.SetPressedEffectContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setPressedEffect(eventsFunctionContext.getArgument("Value"));
}
}}
